...
from utils.utils_agent import (agent_business, gen_subseq, select_next_frame)
from utils.utils_atnet import run_VOS_singleiact
from utils.misc import (AverageMeter, save_agent_checkpoint, sequence_metric, set_random_seed)
...
def davis_config(run, _log):
    ...
    df = None
    agent.memory_pool.basename_csv = cfg_yl.agent.reward_csv
    set_random_seed(2020)
    cfg_yl.num_epochs = 30
            ...
            while sess.next():
                ...
                if vos_kwargs['n_interaction'] == kwargs['max_nb_interactions']:
                    ...
                    _log.info(
                        ...
                        f"agent_loss: {agent_loss.val:.2f} ({agent_loss.avg:.2f})\t"
